...
%------------------------------------------------------------------------
% I need to reprogram this to solve Ut = Vx*Uxx + Vy*Uyy
clc;
close all;
clear all;
%--dimensions...........................................................
...
%alpha needs to be replaced by velocity in Y and X
Vx = 5; 
Vy = 5;
%--boundary conditions----------------------------------------------------
U(1:N,1:N) = 0;
...
DTy = DY^2/(2*Vy);
%should have 2 DT for accounting the Vx and Vy or just put those terms in
%the loop equation
...
while loop==1;
    ...
    for i = 2:N-1
        for j = 2:N-1
            Residue=(DTx*((U_old(i+1,j)-2*U_old(i,j)+U_old(i-1,j))/DX^2 ... 
